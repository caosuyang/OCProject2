...
- (void)createUI
{
    ...
    msgCodeLine.backgroundColor = [UIColor lightGrayColor];
    ...
    [switchBtn mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(codeLine.mas_bottom).offset(10);
    }];
    ...
    UIButton *sendMsgCodeBtn = [[UIButton alloc] init];
...
- (void)registerPhone
{
    ...
    [XBJinRRNetworkApiManager registerWithMobile:self.phoneTextField.text code:self.msgCodeTextField.text password:self.pwdTextField.text rid:self.codeTextField.text block:^(id data) {
