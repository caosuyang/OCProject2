...
@implementation XBEDAINormalQuestionSectionHeaderView
{
...
- (void )creatUI{
    ...
    titleLabel = [ViewCreate createLabelFrame:CGRectMake(0, 0, 0, 0) backgroundColor:WhiteColor text:@"help_down_icon" textColor:RGB(66, 66, 66) textAlignment:Left font:FONT(15)];
    ...
    [titleLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.mas_equalTo(self->leftIconImageView.mas_left).offset(-5);
...
- (void)setTempModel:(XBEDAINormalQuestionModel *)tempModel{
    _tempModel = tempModel;
    leftIconImageView.image = [UIImage imageNamed:_tempModel.isSelected?@"help_down_icon":@"help_right_icon"];
