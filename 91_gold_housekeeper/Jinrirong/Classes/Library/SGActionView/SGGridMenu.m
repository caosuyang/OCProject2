...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        [_cancelButton setTitleColor:[UIColor colorWithRed:74/255.0 green:87/255.0 blue:232/255.0 alpha:1] forState:UIControlStateNormal];
        [_cancelButton addTarget:self
                          action:@selector(tapAction:)
                forControlEvents:UIControlEventTouchUpInside];
        [_cancelButton setBackgroundColor:[UIColor colorWithRed:231/255.0 green:231/255.0 blue:231/255.0 alpha:1]];
...
- (void)setStyle:(SGActionViewStyle)style{
    ...
    [self.cancelButton setTitleColor:[UIColor colorWithRed:74/255.0 green:87/255.0 blue:232/255.0 alpha:1] forState:UIControlStateNormal];
